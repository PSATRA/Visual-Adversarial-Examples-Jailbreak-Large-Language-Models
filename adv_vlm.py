...
def parse_args():
    ...
    parser.add_argument("--mode", type=str, required=True,
                        choices=["attack_constrained", "attack_unconstrained", "test"],
                        help="Choose mode: attack_constrained | attack_unconstrained | test")
    ...
    parser.add_argument('--eps', type=int, default=32,
                        help="epsilon of the attack budget")
    
    parser.add_argument('--alpha', type=int, default=1, 
                        help="step_size of the attack")

    parser.add_argument("--save_dir", type=str, default='output',
                        help="save directory")
    
    parser.add_argument("--image_path", type=str, default=None,
                        help="Path to input image (used in test mode).")
    ...
    if args.mode == "attack_constrained":
        args.constrained = True
    elif args.mode == "attack_unconstrained":
